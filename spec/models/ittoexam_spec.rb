  ...
  describe '模試登録' do
    context 'バリデーション' do
      ...
      it 'yearがないと登録できない' do
        expect(FactoryBot.build(:ittoexam, year: '')).not_to be_valid
      end
        
      it 'monthがないと登録できない' do
        expect(FactoryBot.build(:ittoexam, month: '')).not_to be_valid
      end
        
      it 'student_idがないと登録できない' do
        expect(FactoryBot.build(:ittoexam, student_id: '')).not_to be_valid
      end
    end    
  end
end
