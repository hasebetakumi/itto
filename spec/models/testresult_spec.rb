  ...
  describe '定期試験登録' do
    context 'バリデーション' do
      ...
      it 'student_idがないと登録できない' do
        expect(FactoryBot.build(:testresult, student_id: '')).not_to be_valid
      end
        
      it 'gradeがないと登録できない' do
        expect(FactoryBot.build(:testresult, grade: '')).not_to be_valid
      end
        
      it 'test_idがないと登録できない' do
        expect(FactoryBot.build(:testresult, test_id: '')).not_to be_valid
      end
    end
  end
end
